...
base="dmenu rxvt-unicode i3-wm i3blocks i3lock i3status dunst feh htop rofi unclutter xautolock xorg-server xorg-server-utils xorg-twm xorg-xclock xorg-xinit xorg-xprop xorg-xwininfo"
