...
pacstrap /mnt base base-devel linux linux-firmware intel-ucode efibootmgr dosfstools freetype2 wget curl iw wpa_supplicant dialog xorg-server xorg-apps xorg-twm xorg-xclock xorg-xinit xorg-xprop xorg-xwininfo mesa xf86-video-intel xf86-input-synaptics vi vim bash-completion wireless_tools
